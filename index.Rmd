...
My background is in physical science (earth science, statistical methods, optimization, mapping), computing (sensor networks, the cloud, open source software development), and physics (mathematical and numerical modeling, contaminant transport).  
